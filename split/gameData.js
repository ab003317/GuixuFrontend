...
// --- 核心游戏数据与默认值 ---
// 本文件定义了游戏的核心静态数据, 如难度、属性、性别等, 以及新用户首次使用时的默认天赋/背景数据.
//
// 数据对象:
// - GAME_DATA: 包含游戏的基本规则和设定, 例如不同难度对应的点数、属性列表、可用性别等.
// - DEFAULT_EDITOR_DATA: 为编辑器提供一套默认的天赋、背景和预设, 以便新用户或空世界书的情况下使用.
//
// 加载顺序:
// - 本文件应在脚本早期加载, 为后续的游戏逻辑和UI渲染提供基础数据.
...
const DEFAULT_EDITOR_DATA = {
  talents: [
    ...
    },
    {
      ...
      cost: 25,
      quality: '上品',
      description: '对五行法术有极高的亲和力，修炼五行功法事半半功倍。（四维+50）',
    },
    {
      id: '神农后裔',
      name: '神农后裔',
...
- 终局: 世间再无灵气时，你将彻底湮灭。（无法修仙，但对修仙者造成毁灭性打击）',
    ...
    },
    {
      ...
      quality: '下品',
      description:
        '你必然会被身边的异性因为各种各样的意外侵犯，即使他们并非出于本意。（气运-10）',
    },
    {
      id: '世界调制系统',
      name: '世界调制系统',
      ...
      quality: '神品',
      description:
        '你可以控制区域内所有人的行为规则，效果和范围视修为而定。（神海+500，道心+500）',
    },
    {
      id: '天煞孤星',
      name: '天煞孤星',
...
然天道夺你七情，亦予你弑神之力——兵刃所向必染血光，诸天万法破绽在你眼中纤毫毕现。（气运-50，道心+250，法力+250）',
    },
    {
      ...
      quality: '上品',
      description:
        '人人都好像在梦中见过你，无论你外貌如何初始必定100好感度。（气运+50）',
    },
    {
      id: '赛博灵根',
      name: '赛博灵根',
      ...
      quality: '天品',
      description:
        '你紫府内嵌着纳米结丹，每日可自动推演功法和修炼。（神海+200，修炼速度提升）',
    },
    {
      id: '无限剑制',
      name: '无限剑制',
    ...
    },
    {
      ...
      quality: '中品',
      description:
        '你可以同时和一个人建立感官通道，你俩互相分享感官和情感。（神海+20）',
    },
    {
      id: '月定情缘',
      name: '月定情缘',
    ...
    },
    {
      ...
      quality: '神品',
      description:
        '你可以用一定四维或代价定下一项或数项规则或常识，人人皆认为其为理所应当的并会遵守。（神海+1000）',
    },
    {
      id: '万物启灵',
      name: '万物启灵',
...
肖星构思好这些规矩后，准备建立宗门。（初始境界为神桥境）',
    ...
    },
    {
      ...
      quality: '天品',
      description:
        '你来自一个科技与修仙结合的失落文明，掌握着独特的知识体系。（神海+150，法力+50）',
    },
    {
      id: '“主角”的退婚对象',
      name: '“主角”的退婚对象',
    ...
    },
    {
      ...
      quality: '神品',
      description:
        '你见证了无数个世界的诞生与毁灭，如今来到这个新世界，只是为了观测它的结局。（道心+1000）',
    },
    {
      id: '半人半妖',
      name: '半人半妖',
    ...
    },
    {
      ...
      series: '',
      quality: '神品',
      description: '你的母亲是统治一方的女帝，你生来就拥有无上的权力和资源。（初始四维+100，气运+100）',
    },
  ],
  backgrounds: [],
  presets: []
